...
public class NewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /* TODO output your page here. You may use following sample code. */
            ...
            //Auto auto = new Auto("dacia","lodgy");

                        //String action = request.getParameter("kezdes");

                        //if ("FirstServlet".equals(action)) {
 			if (request.getParameter("kezdes") != null /*"start".equals(action)*/  ) {
				//beléptünk a szervletbe
                                out.println("servlet elindult");
			}
			...
			if (request.getParameter("ujember") != null) {
                                ...
                                if( request.getParameterValues("ceg")!=null ){ //cégtulajdonos létrehozása
			...
			if (request.getParameter("cegtulajtorol") != null) {
				cegtulajdonosok.remove(cegtulajdonosokindex);
                                cegtulajdonosokindex=0;
                                lstcegtulajdonosok = cegtulajdonosok.listIterator();
				...
				out.print("		<form action=\"NewServlet\" method=\"post\">");
				out.print("        <hr>");
				...
				out.print("                <tr>");
				out.print("                    <td>Név</td>");
				out.print("                   <td><input required type=\"text\" name=\"nev\" id=\"nev\"></td>");
				out.print("                </tr>");
				out.print("                <tr>");
				...
				out.print("        <input type=\"submit\" id=\"ujember\" name=\"ujember\" value=\"Új ember felvétele\">");
				out.print("		</form><hr>");
				...
				//emberek adatai
					if (emberek.size()>0){ 
						...
						out.print("		<form action=\"NewServlet\" method=\"post\">");
						out.print("        <br>");
						out.print("        <input type=\"submit\" id=\"emberlistavissza\"  name=\"emberlistavissza\" value=\"<\">&emsp;&emsp;Emberek adatai&emsp;&emsp;<input type=\"submit\" name=\"emberlistaelore\"  id=\"emberlistaelore\" value=\">\">");
				...
				//cégtulajdonosok adatai
					if (cegtulajdonosok.size()>0){ 
						...
						out.print("		<form action=\"NewServlet\" method=\"post\">");
						out.print("        <br>");
						out.print("        <input type=\"submit\" name=\"cegtulajlistavissza\"  id=\"cegtulajlistavissza\" value=\"<\">&emsp;&emsp;Cégtulajdonosok adatai&emsp;&emsp;<input type=\"submit\" name=\"cegtulajlistaelore\"  id=\"cegtulajlistaelore\" value=\">\">");
						out.print("        <br><br>");
						...
						out.print("        </select>");
						out.print("        <br>");
						out.print("        &emsp;<input type=\"submit\" id=\"ujauto\"  name=\"ujauto\" value=\"Autó vásárlása\">");
						out.print("		</form><br><br>");


						out.print("		<form action=\"NewServlet\" method=\"post\">");
						out.print("        <b>Eladhat autót</b>  (de 1 autóval mindig rendelkeznie kell)<br><br>");
						out.print("        &emsp;");
						out.print("        <select name=\"eladottauto\" size=\"1\">");							
							
							//cegtulajdonosok.get(cegtulajdonosokindex).autolist...
						...
						out.print("        &emsp;");
                                                        //csak akkor adhat el autót, ha legalább 2 van neki!
                                                        if(cegtulajdonosok.get(cegtulajdonosokindex).autolist.size()>1){
                                                        out.print("        <input type=\"submit\" id=\"eladas\"  name=\"eladas\" value=\"Autó eladása\">");
                                                        }
						...
						out.print("		<form action=\"NewServlet\" method=\"post\">");
						out.print("        <input type=\"submit\" id=\"vagyonjelentes\"  name=\"vagyonjelentes\" value=\"Vagyon jelentése\">");
						out.print("        <br><br>");
						out.print("        <input type=\"submit\" id=\"cegtulajtorol\"  name=\"cegtulajtorol\" value=\"Cégtulajdonos törlése\">");
						out.print("        <br><br>");
						out.print("		</form><hr>");
					}
